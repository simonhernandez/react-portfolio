...
const Project = ({ id, img, title, description, technologies, link }) => {
  return (
    <div className="project w-[250px] mx-auto shadow-lg rounded-2xl overflow-hidden text-left md:col-span-6 lg:col-span-4 dark:bg-dark_200 transition duration-500">
