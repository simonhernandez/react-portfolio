...
const Hero = () => {
  return (
    <section
      id="home"
      className={`${spacing.paddingY} bg-primary_very_light dark:bg-dark_200 transition duration-500`}
    >
      <Wrapper
        styles={`${layout.wrapper} flex flex-col-reverse md:flex-row md:justify-between md:items-center`}
      >
        {/* Text Container */}
        <div className="space-y-2 ss:space-y-4">
          <h1 className={`${typography.heading1}`}>
            ...
            <Typed
              strings={["Frontend Dev", "Telecom Eng."]}
              typeSpeed={40}
              backSpeed={40}
              backDelay={2500}
              loop
        ...
        <div className="relative">
          ...
          <img
            src={simonHero}
            alt="An image of Simon Hernandez"
            className="w-full max-w-[673px] mx-auto"
          />
