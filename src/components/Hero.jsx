...
const Hero = () => {
  return (
    <section id="home" className={`${spacing.paddingY} bg-primary_very_light dark:bg-dark_200 transition duration-500`}>
      <Wrapper styles={`${layout.wrapper} flex flex-col-reverse md:flex-row md:justify-between md:items-center`}>
        ...
        <div className="relative">
          ...
          <img src={simonHero} alt="An image of Simon Hernandez" className="w-full max-w-[673px] mx-auto" />
